...
pub struct AskMenuGeneralIntentHandler<'a, P: RestaurantInformationPort + ?Sized> {
    information_port: &'a P,
}

impl<'a, P: RestaurantInformationPort + ?Sized> AskMenuGeneralIntentHandler<'a, P> {
...
impl<'a, P: RestaurantInformationPort + Send + Sync + ?Sized> IntentHandler
    for AskMenuGeneralIntentHandler<'a, P>
{
