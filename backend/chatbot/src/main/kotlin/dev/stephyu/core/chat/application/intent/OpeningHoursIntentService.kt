...
class OpeningHoursIntentService(
    ...
    private fun requestedOpeningDay(input: ConversationStateInput, hours: List<OpeningHour>): OpeningHour? {
    ...
    private fun requestedOpeningTime(input: ConversationStateInput): LocalTime? {
